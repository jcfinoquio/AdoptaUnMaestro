document.addEventListener("DOMContentLoaded", () => {
  ...
  if (resultadosColegios) {
    const colegios =[{ id: 1, nombre: "Colegio San José", ciudad: "Sevilla", provincia: "Sevilla", tipo: "Concertado", resumen: "Centro con amplia trayectoria en educación primaria y secundaria.", telefono: "954 123 456", logo: "https://images.unsplash.com/photo-1562774053-701939374585?w=400&h=300&fit=crop" },
